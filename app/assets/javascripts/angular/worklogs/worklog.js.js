...
app.factory("Worklog", ["RailsResource", "Timeframe", "railsSerializer", "Client", "UiNotifier", function(RailsResource, Timeframe, railsSerializer, Client, UiNotifier){
  class Worklog extends RailsResource {
    static initClass() {
      this.configure({url: '/worklogs', name: 'worklog', serializer: railsSerializer(function() {
        ...
        this.add("client_id", function(wl){
          if (wl.client) { return wl.client.id; } else { return null; }
        });
    ...
    creditBlocked() {
      return this.client && this.client.creditBlockReason && this.client.creditBlockReason.length;
    }
